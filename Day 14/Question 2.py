...
#convert the 'transaction_date' column elemnets into datetime objects and filter the dataframe to only include transactions that occurred in July 2024
...
#calculate the average transaction_value for loyalty program members and non-members
